...
const ANSWER_ALIASES = {
  '眼鏡':['めがね','メガネ'], '石けん':['せっけん','石鹸'], '絆創膏':['ばんそうこう'], '将棋駒':['しょうぎごま','将棋の駒'],
  '鉛筆':['えんぴつ'], '消しゴム':['けしごむ'], '定規':['じょうぎ'], '封筒':['ふうとう'], '切手':['きって'],
  '傘':['かさ'], '鍵':['かぎ'], '時計':['とけい'], '財布':['さいふ'], '帽子':['ぼうし'],
  '靴':['くつ'], '靴下':['くつした'], '手袋':['てぶくろ'], '歯ブラシ':['はぶらし'], '冷蔵庫':['れいぞうこ'],
  '洗濯機':['せんたくき'], '電子レンジ':['でんしれんじ'], '掃除機':['そうじき'], '扇風機':['せんぷうき'], '電話':['でんわ'],
  '電池':['でんち'], '机':['つくえ'], '椅子':['いす'], '本棚':['ほんだな'], '鏡':['かがみ'],
  '布団':['ふとん'], '自転車':['じてんしゃ'], '自動車':['じどうしゃ'], '電車':['でんしゃ'], '飛行機':['ひこうき'],
  '船':['ふね'], '信号':['しんごう'], '地図':['ちず'], '切符':['きっぷ'], '野球ボール':['やきゅうぼーる','やきゅうボール'],
  '縄跳び':['なわとび'], 'スキー板':['すきーいた','すきーばん'], 'スケート靴':['すけーとぐつ'], '水筒':['すいとう'], '笛':['ふえ'],
  '本':['ほん'], '新聞':['しんぶん'], '茶碗':['ちゃわん'], '皿':['さら'], '箸':['はし'],
  '包丁':['ほうちょう'], '鍋':['なべ'], '卵':['たまご'], '牛乳':['ぎゅうにゅう'], '爪切り':['つめきり'],
  '体温計':['たいおんけい'], '懐中電灯':['かいちゅうでんとう'], '虫眼鏡':['むしめがね'], '双眼鏡':['そうがんきょう'], '教科書':['きょうかしょ'],
  '黒板':['こくばん'], '輪ゴム':['わごむ'], '画びょう':['がびょう'], '色鉛筆':['いろえんぴつ'], '筆箱':['ふでばこ'],
  '長靴':['ながぐつ'], '積み木':['つみき'], '風船':['ふうせん'], '折り紙':['おりがみ'], 'けん玉':['けんだま'],
  'シャボン玉':['しゃぼんだま'],
};
