...
function isCorrectGuess(guess, topic) { const normalized = normalizeAnswer(guess); return normalized.length > 0 && normalized === normalizeAnswer(topic); }
...
const api = { MIN_PLAYERS, ROUNDS, TOPIC_BANK, shuffle, selectRoundTopic, buildTurnOrder, totalTurns, currentTurnInfo, normalizeAnswer, isCorrectGuess, undoLastStroke, applyScoreDeltas, buildScoreboard, getWinners, addPlayer, removePlayer, hasMinPlayers };
